...
//   const handleSendOTP = () => {
//     // Replace RECAPTCHA_CONTAINER_ID with the ID of an HTML element where you want to render the reCAPTCHA widget.
//     const recaptchaVerifier = new RecaptchaVerifier("RECAPTCHA_CONTAINER_ID", {
//       size: "normal",
//       callback: () => {
//         // ReCAPTCHA verification succeeded. Send OTP.
//         const phoneNumberWithCountryCode = `+1${phoneNumber}`; // Replace with your country code.
        
//         signInWithPhoneNumber(auth, phoneNumberWithCountryCode, recaptchaVerifier)
//           .then((confirmationResult) => {
//             // OTP sent successfully. Handle confirmationResult.
//             // You can navigate to the OTP verification page.
//           })
//           .catch((error) => {
//             console.error(error);
